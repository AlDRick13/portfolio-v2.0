                            ...
                            <CardActionArea>
                                ...
                                <CardContent>
                                    ...
                                    <div className="w-full flex">
                                        <a href={project.repo} target="_blank" className="w-1/2 text-center hover:scale-150 ease-in duration-100"><GitHubIcon></GitHubIcon></a>
                                        <a href={project.demo} target="_blank" className="w-1/2 text-center hover:scale-150 ease-in duration-100"><WebIcon></WebIcon></a>
                                    </div>
                                </CardContent>
                            </CardActionArea>
                        </Card>
